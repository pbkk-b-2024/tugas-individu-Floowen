...
@section("content")
    <div class="content">
        <h1 class="font-bold text-3xl">Item Catalogs</h1><br>
        @if(Auth::user()->role == "Admin")
            <a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" href="{{ route('addusers') }}">Add a Item</a>
            <br><br>
        @endif
        <form class="max-w-md">
        ...
        <div class="my-4 max-w-fit">
            ...
            <tbody>
                ...
                <td class="text-wrap">{{ $item -> content }}</td>
                    @if(Auth::user()->role == "Admin")
                        <td><a class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" href="/user/{{ $item -> id }}">Update</a></td>
                        <td><a class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" href="/delete/{{ $item -> id }}">Delete</a></td>
                    @endif
                </tr>
                @endforeach
            </tbody>
